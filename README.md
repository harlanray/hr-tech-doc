# HR Tech Documentation

A sample implementation showcasing the concept of how a text document is written for various technologies and software constructs. This is really just an excercise in how to format a text document within an HTML & CSS.
...
We use [Semantic Versioning](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/harlanray/hr-tech-doc/releases).
...
## Acknowledgments
  ...
  - Based on the [freeCodeCamp](https://www.freecodecamp.org/learn/2022/responsive-web-design/build-a-technical-documentation-page-project/build-a-technical-documentation-page) course project 
  - Inspired by technology documentation everywhere!!